...
@Component({
  selector: 'app-cat-esepices',
  templateUrl: './cat-esepices.component.html',
  styleUrls: ['./cat-esepices.component.css']
})
export class CatEsepicesComponent implements OnInit,OnDestroy {
  customOptions: any = {
    loop: true,
    mouseDrag: true,
    touchDrag: true,
  ...
  ngOnInit(): void {
    ...
    this.subs = this.serv.getcat_epices().subscribe(data => {
