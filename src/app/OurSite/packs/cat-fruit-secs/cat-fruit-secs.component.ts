...
@Component({
  selector: 'app-cat-fruit-secs',
  templateUrl: './cat-fruit-secs.component.html',
  styleUrls: ['./cat-fruit-secs.component.css']
})
export class CatFruitSecsComponent implements OnInit,OnDestroy {
  customOptions: any = {
    loop: true,
    mouseDrag: true,
    touchDrag: true,
  ...
  ngOnInit(): void {
    ...
    this.subs = this.serv.getcat_frui_secs().subscribe(data => {
