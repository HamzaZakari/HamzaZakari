...
@Component({
  selector: 'app-cat-meil',
  templateUrl: './cat-meil.component.html',
  styleUrls: ['./cat-meil.component.css']
})
export class CatMeilComponent implements OnInit, OnDestroy {
  customOptions: any = {
    loop: true,
    mouseDrag: true,
    touchDrag: true,
...
subs: Subscription;
  ...
  ngOnInit(): void {
    ...
    this.subs = this.serv.getcat_meil().subscribe(data => {
