...
@Component({
  selector: 'app-res-fruit-secs',
  templateUrl: './res-fruit-secs.component.html',
  styleUrls: ['./res-fruit-secs.component.css']
})
export class ResFruitSecsComponent implements OnInit {
  PoidsQuick: any[] = [];
  QuickDetail: any = [];
  proID;
  subs4: Subscription;
  ...
  qtypoids = null;
  poids: any[] = [];
  constructor(private pack: PackserviceService,private MatSnakbar: MatSnackBar,  private services: ServicesService,@Inject(DOCUMENT) private document: Document) { }
  ...
  ngOnInit(): void {
    ...
    this.pack.getcat_frui_secs().subscribe(data => {
