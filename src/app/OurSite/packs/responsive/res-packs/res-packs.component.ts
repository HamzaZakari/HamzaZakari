...
@Component({
  selector: 'app-res-packs',
  templateUrl: './res-packs.component.html',
  styleUrls: ['./res-packs.component.css']
})
export class ResPacksComponent implements OnInit {
PoidsQuick: any[] = [];
QuickDetail: any = [];
proID;
subs4: Subscription;
  ...
  ngOnInit(): void {
    ...
    this.pack.getPacks();
     this.pack.oserverpacks().subscribe(data => {
      this.meil1 = data.slice(0,2);
      this.meil2 = data.slice(2,4);
       this.cat_id = data[0].category_id;
       this.boutique_id = data[0].id_boutique;
    })
  }
  getproPoids(id) {
