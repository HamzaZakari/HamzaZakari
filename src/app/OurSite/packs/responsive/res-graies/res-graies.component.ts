...
@Component({
  selector: 'app-res-graies',
  templateUrl: './res-graies.component.html',
  styleUrls: ['./res-graies.component.css']
})
export class ResGraiesComponent implements OnInit {
  PoidsQuick: any[] = [];
  QuickDetail: any  = [];
  proID;
  subs4: Subscription;
  ...
  ngOnInit(): void {
    ...
    this.pack.getcat_graines().subscribe(data => {
