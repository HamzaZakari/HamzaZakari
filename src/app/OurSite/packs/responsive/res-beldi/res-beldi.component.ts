...
@Component({
  selector: 'app-res-beldi',
  templateUrl: './res-beldi.component.html',
  styleUrls: ['./res-beldi.component.css']
})
export class ResBeldiComponent implements OnInit {
  PoidsQuick: any[] = [];
  QuickDetail: any = [];
  proID;
  subs4: Subscription;
  ...
  ngOnInit(): void {
    ...
    this.pack.getcat_beldi().subscribe(data => {
