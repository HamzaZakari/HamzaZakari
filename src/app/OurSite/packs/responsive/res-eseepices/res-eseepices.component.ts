...
@Component({
  selector: 'app-res-eseepices',
  templateUrl: './res-eseepices.component.html',
  styleUrls: ['./res-eseepices.component.css']
})
export class ResEseepicesComponent implements OnInit {
 PoidsQuick: any[] = [];
 QuickDetail: any = [];
 proID;
 subs4: Subscription;
  ...
  ngOnInit(): void {
    ...
    this.pack.getcat_epices().subscribe(data => {
