...
@Component({
  selector: 'app-cat-oliver-cornichons',
  templateUrl: './cat-oliver-cornichons.component.html',
  styleUrls: ['./cat-oliver-cornichons.component.css']
})
export class CatOliverCornichonsComponent implements OnInit, OnDestroy{
  customOptions: any = {
    loop: true,
    mouseDrag: true,
    touchDrag: true,
  ...
  proID;
  subs4: Subscription;
  constructor(private serv: PackserviceService,private serv2: ServicesService,private MatSnakbar: MatSnackBar,  @Inject(DOCUMENT) private document: Document) { }
  ...
  ngOnInit(): void {
    ...
    this.subs = this.serv.getcat_oliver_cornichon().subscribe(data => {
