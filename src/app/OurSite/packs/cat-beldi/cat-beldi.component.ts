...
@Component({
  selector: 'app-cat-beldi',
  templateUrl: './cat-beldi.component.html',
  styleUrls: ['./cat-beldi.component.css']
})
export class CatBeldiComponent implements OnInit, OnDestroy {
  show_quick = '';
  proID;
  subs4: Subscription;
  customOptions: any = {
  ...
  ngOnInit(): void {
    ...
    this.subs = this.serv.getcat_beldi().subscribe(data => {
